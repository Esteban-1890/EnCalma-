...
<body>
    <div class="container" style="margin: 30px auto ">
        <div class="form-box">
            ...
            <form action="../Control/ctrlUsuario.php" method="post" class="form-body" onsubmit="return validarFormulario();">
                <input type="text" name="nombre" placeholder="Nombre" required />
                <input type="text" name="apellidos" placeholder="Apellidos" required />
                <input type="tel" name="num_tel" placeholder="Teléfono" required />
                <input type="email" name="correo_e" placeholder="Correo electrónico" required />
                ...
                <button type="submit"onclick="location.href='../Index.php'">REGISTRAR</button>
                <br>
